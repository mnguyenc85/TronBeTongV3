...
{
    /// <summary>
    /// Interaction logic for CtrlBin02.xaml
    /// </summary>
    public partial class CtrlBin02 : UserControl
    {
        ...
        public static readonly DependencyProperty ZTitleProperty =
            DependencyProperty.Register("ZTitle", typeof(string), typeof(CtrlBin02), new PropertyMetadata(null));
        #endregion
        ...
        public static readonly DependencyProperty ZFillProperty =
            DependencyProperty.Register("ZFill", typeof(Brush), typeof(CtrlBin02), new PropertyMetadata(null, OnZFillPropertyChanged));
        ...
        public static readonly DependencyProperty ZOn1Property =
            DependencyProperty.Register("ZOn1", typeof(int), typeof(CtrlBin02), new PropertyMetadata(0, OnZOnPropertyChanged));
        public int ZOn2
        {
        ...
        public static readonly DependencyProperty ZOn2Property =
            DependencyProperty.Register("ZOn2", typeof(int), typeof(CtrlBin02), new PropertyMetadata(0, OnZOnPropertyChanged));
        ...
        public static readonly DependencyProperty ZTimeOn1Property =
            DependencyProperty.Register("ZTimeOn1", typeof(double), typeof(CtrlBin02), new PropertyMetadata(0d, OnZTimeOnPropertyChanged));
        ...
        public static readonly DependencyProperty ZTimeOn2Property =
            DependencyProperty.Register("ZTimeOn2", typeof(double), typeof(CtrlBin02), new PropertyMetadata(0d, OnZTimeOnPropertyChanged));
        ...
        public static readonly DependencyProperty ZHasVibProperty =
            DependencyProperty.Register("ZHasVib", typeof(bool), typeof(CtrlBin02), new PropertyMetadata(true, OnZHasVibChanged));

        private static void OnZHasVibChanged(DependencyObject d, DependencyPropertyChangedEventArgs e)
        {
            if (d is CtrlBin02 s) s.BtVib.Visibility = s.ZHasVib ? Visibility.Visible : Visibility.Collapsed;
        }
        #endregion
        ...
        public static readonly DependencyProperty ZEnabledProperty =
            DependencyProperty.Register("ZEnabled", typeof(bool), typeof(CtrlBin02), new PropertyMetadata(true, OnZEnabledPropertyChanged));
        ...
        {
            double cp = Math.Round(capphoi, 1);
            double tt = Math.Round(m3, 1);

            TxtField1.Text = cp.ToString("0.0");
            //if (some > 0)
            //    TxtField2.Text = (cp * tt / some).ToString("0.0");
            //else TxtField2.Text = "-";
        ...
        {
            if (some > 0) TxtField2.Text = kl.ToString("F1");
            else TxtField2.Text = "-";
        }
        ...
        public void UpdateTag(int i, double v)
        {
            if (i == 3)
            {
                TxtField3.Text = v.ToString("F1");
            }
            else if (i == 4)
            {
                TxtField4.Text = v.ToString("F1");
            }
            else if (i == 5)
            {
                TxtField5.Text = v.ToString("F1");
            }
        }
